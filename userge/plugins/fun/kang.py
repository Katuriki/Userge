...
@userge.on_cmd(
    ...
    "steal", about={
        ...
        'header': "steals stickers or creates new ones",
        ...
        'usage': "Reply {tr}steal [emoji('s)] [pack number] to a sticker or "

                 "an image to steal it to your userbot pack.",

        'examples': ["{tr}steal", "{tr}steal -s", "{tr}steal -d",

                     "{tr}steal 🤔😎", "{tr}steal 2", "{tr}steal 🤔🤣😂 2"]},

    allow_channels=False, allow_via_bot=False)

async def steal_(message: Message):
    ...
    if replied and replied.media:
        ...
        await message.edit(f"`{random.choice(stealING_STR)}`")
        ...
        await message.edit("`I can't steal that,Abhi ;-;`")
    ...
    if photo:
        ...
        custom_packnick = Config.CUSTOM_PACK_NAME or f"𝐀𝐤𝐢𝐫𝐚'𝐬"

        packnick = f"{custom_packnick} 𝐏𝐚𝐜𝐤"
        ...
        if exist is not False:
            ...
            async with userge.conversation('Stickers', limit=30) as conv:
                ...
                while limit in msg.text:
                    ...
                    packnick = f"{custom_packnick} 𝐏𝐚𝐜𝐤{pack}"
                    ...
                    if msg.text == "Invalid pack selected.":
                        ...
                        if '-d' in message.flags:
                            ...
                            out = "__stealed__" if '-s' in message.flags else \
            ...
            await message.edit("`Creating a new Pack...`")
